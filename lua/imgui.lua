...
function Imgui_Impl_glfw_opengl3:Init(window, install_callbacks,fontAt)
    self.igctx = lib.igCreateContext(fontAt);
	lib.igSetCurrentContext(self.igctx)
...
function Imgui_Impl_glfw_opengl3:NewFrame()
	if lib.igGetCurrentContext() ~= self.igctx then
		lib.igSetCurrentContext(self.igctx)
	end
