...
typedef ImVector ImVector_ImWchar;
 ...
 _Bool ImGui_ImplGlfw_InitForOpenGL(GLFWwindow* window,_Bool install_callbacks);
 _Bool ImGui_ImplGlfw_InitForVulkan(GLFWwindow* window,_Bool install_callbacks);
