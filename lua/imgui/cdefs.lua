...
ImPlotLimits* ImPlotLimits_ImPlotLimits_Nil(void);
void ImPlotLimits_destroy(ImPlotLimits* self);
ImPlotLimits* ImPlotLimits_ImPlotLimits_double(double x_min,double x_max,double y_min,double y_max);
_Bool                ImPlotLimits_Contains_PlotPoInt(ImPlotLimits* self,const ImPlotPoint p);
_Bool                ImPlotLimits_Contains_double(ImPlotLimits* self,double x,double y);
...
double ImPlot_PlotHistogram2D_FloatPtr(const char* label_id,const float* xs,const float* ys,int count,int x_bins,int y_bins,                                                                                                                                      _Bool                                                                                                                                            density,ImPlotLimits range,                                                                                                                                                                      _Bool                                                                                                                                                                            outliers);
double ImPlot_PlotHistogram2D_doublePtr(const char* label_id,const double* xs,const double* ys,int count,int x_bins,int y_bins,                                                                                                                                         _Bool                                                                                                                                               density,ImPlotLimits range,                                                                                                                                                                         _Bool                                                                                                                                                                               outliers);
double ImPlot_PlotHistogram2D_S8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,int count,int x_bins,int y_bins,                                                                                                                                 _Bool                                                                                                                                       density,ImPlotLimits range,                                                                                                                                                                 _Bool                                                                                                                                                                       outliers);
double ImPlot_PlotHistogram2D_U8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,int count,int x_bins,int y_bins,                                                                                                                                 _Bool                                                                                                                                       density,ImPlotLimits range,                                                                                                                                                                 _Bool                                                                                                                                                                       outliers);
double ImPlot_PlotHistogram2D_S16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,int count,int x_bins,int y_bins,                                                                                                                                    _Bool                                                                                                                                          density,ImPlotLimits range,                                                                                                                                                                    _Bool                                                                                                                                                                          outliers);
double ImPlot_PlotHistogram2D_U16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,int count,int x_bins,int y_bins,                                                                                                                                    _Bool                                                                                                                                          density,ImPlotLimits range,                                                                                                                                                                    _Bool                                                                                                                                                                          outliers);
double ImPlot_PlotHistogram2D_S32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,int count,int x_bins,int y_bins,                                                                                                                                    _Bool                                                                                                                                          density,ImPlotLimits range,                                                                                                                                                                    _Bool                                                                                                                                                                          outliers);
double ImPlot_PlotHistogram2D_U32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,int count,int x_bins,int y_bins,                                                                                                                                    _Bool                                                                                                                                          density,ImPlotLimits range,                                                                                                                                                                    _Bool                                                                                                                                                                          outliers);
double ImPlot_PlotHistogram2D_S64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,int count,int x_bins,int y_bins,                                                                                                                                    _Bool                                                                                                                                          density,ImPlotLimits range,                                                                                                                                                                    _Bool                                                                                                                                                                          outliers);
double ImPlot_PlotHistogram2D_U64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,int count,int x_bins,int y_bins,                                                                                                                                    _Bool                                                                                                                                          density,ImPlotLimits range,                                                                                                                                                                    _Bool                                                                                                                                                                          outliers);
...
void ImPlot_SetNextPlotTicksX_doublePtr(const double* values,int n_ticks,const char* const labels[],                                                                                                              _Bool                                                                                                                    show_default);
void ImPlot_SetNextPlotTicksX_double(double x_min,double x_max,int n_ticks,const char* const labels[],                                                                                                                _Bool                                                                                                                      show_default);
void ImPlot_SetNextPlotTicksY_doublePtr(const double* values,int n_ticks,const char* const labels[],                                                                                                              _Bool                                                                                                                    show_default,ImPlotYAxis y_axis);
void ImPlot_SetNextPlotTicksY_double(double y_min,double y_max,int n_ticks,const char* const labels[],                                                                                                                _Bool                                                                                                                      show_default,ImPlotYAxis y_axis);
...
void ImPlot_AnnotateV_Vec4(double x,double y,const ImVec2 pix_offset,const ImVec4 color,const char* fmt,va_list args);
...
void ImPlot_AnnotateClampedV_Vec4(double x,double y,const ImVec2 pix_offset,const ImVec4 color,const char* fmt,va_list args);
...
void ImPlotTickCollection_Append_PlotTick(ImPlotTickCollection* self,const ImPlotTick tick);
void ImPlotTickCollection_Append_double(ImPlotTickCollection* self,double value,                                                                                          _Bool                                                                                                major,                                                                                                     _Bool                                                                                                           show_label,void(*labeler)(ImPlotTick& tick,ImGuiTextBuffer& buf));
...
float ImPlot_OffsetAndStride_FloatPtr(const float* data,int idx,int count,int offset,int stride);
double ImPlot_OffsetAndStride_doublePtr(const double* data,int idx,int count,int offset,int stride);
ImS8 ImPlot_OffsetAndStride_S8Ptr(const ImS8* data,int idx,int count,int offset,int stride);
ImU8 ImPlot_OffsetAndStride_U8Ptr(const ImU8* data,int idx,int count,int offset,int stride);
ImS16 ImPlot_OffsetAndStride_S16Ptr(const ImS16* data,int idx,int count,int offset,int stride);
ImU16 ImPlot_OffsetAndStride_U16Ptr(const ImU16* data,int idx,int count,int offset,int stride);
ImS32 ImPlot_OffsetAndStride_S32Ptr(const ImS32* data,int idx,int count,int offset,int stride);
ImU32 ImPlot_OffsetAndStride_U32Ptr(const ImU32* data,int idx,int count,int offset,int stride);
ImS64 ImPlot_OffsetAndStride_S64Ptr(const ImS64* data,int idx,int count,int offset,int stride);
ImU64 ImPlot_OffsetAndStride_U64Ptr(const ImU64* data,int idx,int count,int offset,int stride);
