...
ImVec2 igGetMouseDragDelta(ImGuiMouseButton button,float lock_threshold);
...
void igGetMouseDragDelta_nonUDT(ImVec2 *pOut,ImGuiMouseButton button,float lock_threshold);
ImVec2_Simple igGetMouseDragDelta_nonUDT2(ImGuiMouseButton button,float lock_threshold);
