...
_Bool                igCheckboxFlagsIntPtr(const char* label,int* flags,int flags_value);
_Bool                igCheckboxFlagsUintPtr(const char* label,unsigned int* flags,unsigned int flags_value);
...
_Bool                igCollapsingHeaderBoolPtr(const char* label,                                                           _Bool                                                               * p_visible,ImGuiTreeNodeFlags flags);
...
_Bool                igImIsPowerOfTwoInt(int v);
_Bool                igImIsPowerOfTwoU64(ImU64 v);
...
ImGuiItemFlags igGetItemsFlags(void);
...
_Bool                igScrollbarEx(const ImRect bb,ImGuiID id,ImGuiAxis axis,float* p_scroll_v,float avail_v,float contents_v,ImDrawFlags flags);
...
_Bool                igCheckboxFlagsS64Ptr(const char* label,ImS64* flags,ImS64 flags_value);
_Bool                igCheckboxFlagsU64Ptr(const char* label,ImU64* flags,ImU64 flags_value);
...
struct ImPlotNextPlotData
{
    ...
    ImPlotRange Y[3];
       _Bool         HasXRange;
       _Bool         HasYRange[3];
       _Bool         ShowDefaultTicksX;
       _Bool         ShowDefaultTicksY[3];
       _Bool         FitX;
       _Bool         FitY[3];
    double* LinkedXmin;
    double* LinkedXmax;
...
void ImPlot_PlotVLinesFloatPtr(const char* label_id,const float* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesdoublePtr(const char* label_id,const double* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesS8Ptr(const char* label_id,const ImS8* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesU8Ptr(const char* label_id,const ImU8* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesS16Ptr(const char* label_id,const ImS16* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesU16Ptr(const char* label_id,const ImU16* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesS32Ptr(const char* label_id,const ImS32* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesU32Ptr(const char* label_id,const ImU32* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesS64Ptr(const char* label_id,const ImS64* xs,int count,int offset,int stride);
void ImPlot_PlotVLinesU64Ptr(const char* label_id,const ImU64* xs,int count,int offset,int stride);
void ImPlot_PlotHLinesFloatPtr(const char* label_id,const float* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesdoublePtr(const char* label_id,const double* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesS8Ptr(const char* label_id,const ImS8* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesU8Ptr(const char* label_id,const ImU8* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesS16Ptr(const char* label_id,const ImS16* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesU16Ptr(const char* label_id,const ImU16* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesS32Ptr(const char* label_id,const ImS32* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesU32Ptr(const char* label_id,const ImU32* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesS64Ptr(const char* label_id,const ImS64* ys,int count,int offset,int stride);
void ImPlot_PlotHLinesU64Ptr(const char* label_id,const ImU64* ys,int count,int offset,int stride);
...
_Bool                ImPlot_BeginDragDropTarget(void);
_Bool                ImPlot_BeginDragDropTargetX(void);
_Bool                ImPlot_BeginDragDropTargetY(ImPlotYAxis axis);
_Bool                ImPlot_BeginDragDropTargetLegend(void);
void ImPlot_EndDragDropTarget(void);
_Bool                ImPlot_BeginDragDropSource(ImGuiKeyModFlags key_mods,ImGuiDragDropFlags flags);
_Bool                ImPlot_BeginDragDropSourceX(ImGuiKeyModFlags key_mods,ImGuiDragDropFlags flags);
_Bool                ImPlot_BeginDragDropSourceY(ImPlotYAxis axis,ImGuiKeyModFlags key_mods,ImGuiDragDropFlags flags);
...
float ImPlot_ImRemapFloat(float x,float x0,float x1,float y0,float y1);
double ImPlot_ImRemapdouble(double x,double x0,double x1,double y0,double y1);
ImS8 ImPlot_ImRemapS8(ImS8 x,ImS8 x0,ImS8 x1,ImS8 y0,ImS8 y1);
ImU8 ImPlot_ImRemapU8(ImU8 x,ImU8 x0,ImU8 x1,ImU8 y0,ImU8 y1);
ImS16 ImPlot_ImRemapS16(ImS16 x,ImS16 x0,ImS16 x1,ImS16 y0,ImS16 y1);
ImU16 ImPlot_ImRemapU16(ImU16 x,ImU16 x0,ImU16 x1,ImU16 y0,ImU16 y1);
ImS32 ImPlot_ImRemapS32(ImS32 x,ImS32 x0,ImS32 x1,ImS32 y0,ImS32 y1);
...
void ImBufferWriter_WriteV(ImBufferWriter* self,const char* fmt,va_list args);
...
ImPlotTime* ImPlotTime_ImPlotTimeNil(void);
void ImPlotTime_destroy(ImPlotTime* self);
ImPlotTime* ImPlotTime_ImPlotTimetime_t(time_t s,int us);
...
void ImPlotTickCollection_AppendPlotTick(ImPlotTickCollection* self,const ImPlotTick tick);
void ImPlotTickCollection_Appenddouble(ImPlotTickCollection* self,double value,                                                                                         _Bool                                                                                               major,                                                                                                    _Bool                                                                                                          show_label,void(*labeler)(ImPlotTick& tick,ImGuiTextBuffer& buf));
...
_Bool                ImPlotAxis_SetMin(ImPlotAxis* self,double _min);
_Bool                ImPlotAxis_SetMax(ImPlotAxis* self,double _max);
void ImPlotAxis_SetRangedouble(ImPlotAxis* self,double _min,double _max);
void ImPlotAxis_SetRangePlotRange(ImPlotAxis* self,const ImPlotRange range);
...
void ImPlot_Reset(ImPlotContext* ctx);
...
int ImPlot_GetCurrentYAxis(void);
void ImPlot_UpdateAxisColors(int axis_flag,ImPlotAxis* axis);
void ImPlot_UpdateTransformCache(void);
...
void ImPlot_CalcLegendSize(ImVec2 *pOut,ImPlotPlot* plot,const ImVec2 pad,const ImVec2 spacing,ImPlotOrientation orientation);
void ImPlot_ShowLegendEntries(ImPlotPlot* plot,const ImRect legend_bb,                                                                                _Bool                                                                                      interactable,const ImVec2 pad,const ImVec2 spacing,ImPlotOrientation orientation,ImDrawList* DrawList);
void ImPlot_ShowAltLegend(const char* title_id,ImPlotOrientation orientation,const ImVec2 size,                                                                                                         _Bool                                                                                                               interactable);
void ImPlot_LabelTickDefault(ImPlotTick* tick,ImGuiTextBuffer* buffer);
void ImPlot_LabelTickScientific(ImPlotTick* tick,ImGuiTextBuffer* buffer);
void ImPlot_LabelTickTime(ImPlotTick* tick,ImGuiTextBuffer* buffer,const ImPlotTime t,ImPlotDateTimeFmt fmt);
void ImPlot_AddTicksDefault(const ImPlotRange range,int nMajor,int nMinor,ImPlotTickCollection* ticks);
void ImPlot_AddTicksLogarithmic(const ImPlotRange range,int nMajor,ImPlotTickCollection* ticks);
void ImPlot_AddTicksTime(const ImPlotRange range,float plot_width,ImPlotTickCollection* ticks);
void ImPlot_AddTicksCustom(const double* values,const char* const labels[],int n,ImPlotTickCollection* ticks);
...
_Bool                ImPlot_IsColorAutoVec4(const ImVec4 col);
_Bool                ImPlot_IsColorAutoPlotCol(ImPlotCol idx);
...
void ImPlot_FillRangeVector_FloatPtr(ImVector_float* buffer,int n,float vmin,float vmax);
void ImPlot_FillRangeVector_doublePtr(ImVector_double* buffer,int n,double vmin,double vmax);
void ImPlot_FillRangeVector_S8Ptr(ImVector_ImS8* buffer,int n,ImS8 vmin,ImS8 vmax);
void ImPlot_FillRangeVector_U8Ptr(ImVector_ImU8* buffer,int n,ImU8 vmin,ImU8 vmax);
void ImPlot_FillRangeVector_S16Ptr(ImVector_ImS16* buffer,int n,ImS16 vmin,ImS16 vmax);
void ImPlot_FillRangeVector_U16Ptr(ImVector_ImU16* buffer,int n,ImU16 vmin,ImU16 vmax);
void ImPlot_FillRangeVector_S32Ptr(ImVector_ImS32* buffer,int n,ImS32 vmin,ImS32 vmax);
void ImPlot_FillRangeVector_U32Ptr(ImVector_ImU32* buffer,int n,ImU32 vmin,ImU32 vmax);
void ImPlot_FillRangeVector_S64Ptr(ImVector_ImS64* buffer,int n,ImS64 vmin,ImS64 vmax);
void ImPlot_FillRangeVector_U64Ptr(ImVector_ImU64* buffer,int n,ImU64 vmin,ImU64 vmax);
float ImPlot_OffsetAndStrideFloatPtr(const float* data,int idx,int count,int offset,int stride);
double ImPlot_OffsetAndStridedoublePtr(const double* data,int idx,int count,int offset,int stride);
ImS8 ImPlot_OffsetAndStrideS8Ptr(const ImS8* data,int idx,int count,int offset,int stride);
ImU8 ImPlot_OffsetAndStrideU8Ptr(const ImU8* data,int idx,int count,int offset,int stride);
ImS16 ImPlot_OffsetAndStrideS16Ptr(const ImS16* data,int idx,int count,int offset,int stride);
ImU16 ImPlot_OffsetAndStrideU16Ptr(const ImU16* data,int idx,int count,int offset,int stride);
ImS32 ImPlot_OffsetAndStrideS32Ptr(const ImS32* data,int idx,int count,int offset,int stride);
...
ImPlotTime ImPlot_MkLocTime(struct tm* ptm);
tm* ImPlot_GetLocTime(const ImPlotTime t,tm* ptm);
ImPlotTime ImPlot_MakeTime(int year,int month,int day,int hour,int min,int sec,int us);
int ImPlot_GetYear(const ImPlotTime t);
ImPlotTime ImPlot_AddTime(const ImPlotTime t,ImPlotTimeUnit unit,int count);
ImPlotTime ImPlot_FloorTime(const ImPlotTime t,ImPlotTimeUnit unit);
ImPlotTime ImPlot_CeilTime(const ImPlotTime t,ImPlotTimeUnit unit);
ImPlotTime ImPlot_RoundTime(const ImPlotTime t,ImPlotTimeUnit unit);
ImPlotTime ImPlot_CombineDateTime(const ImPlotTime date_part,const ImPlotTime time_part);
...
Context* imnodes_CreateContext(void);
void imnodes_DestroyContext(Context* ctx);
Context* imnodes_GetCurrentContext(void);
void imnodes_SetCurrentContext(Context* ctx);
