...
function ImVector.__new()
    local ptr = lib.ImVector_ImVector()
    ffi.gc(ptr,lib.ImVector_destroy)
    return ptr
end
ImVector._grow_capacity = lib.ImVector__grow_capacity
ImVector.back = lib.ImVector_back
ImVector.back_const = lib.ImVector_back_const
ImVector.begin = lib.ImVector_begin
ImVector.begin_const = lib.ImVector_begin_const
ImVector.capacity = lib.ImVector_capacity
ImVector.clear = lib.ImVector_clear
ImVector.empty = lib.ImVector_empty
ImVector._end = lib.ImVector_end
ImVector.end_const = lib.ImVector_end_const
ImVector.erase = lib.ImVector_erase
ImVector.eraseTPtr = lib.ImVector_eraseTPtr
ImVector.erase_unsorted = lib.ImVector_erase_unsorted
ImVector.front = lib.ImVector_front
ImVector.front_const = lib.ImVector_front_const
ImVector.index_from_ptr = lib.ImVector_index_from_ptr
ImVector.insert = lib.ImVector_insert
ImVector.pop_back = lib.ImVector_pop_back
ImVector.push_back = lib.ImVector_push_back
ImVector.push_front = lib.ImVector_push_front
ImVector.reserve = lib.ImVector_reserve
ImVector.resize = lib.ImVector_resize
ImVector.resizeT = lib.ImVector_resizeT
ImVector.size = lib.ImVector_size
ImVector.size_in_bytes = lib.ImVector_size_in_bytes
ImVector.swap = lib.ImVector_swap
M.ImVector = ffi.metatype("ImVector",ImVector)
